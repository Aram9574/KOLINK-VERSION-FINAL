...
interface LockedAutoPilotStateProps {
    onUpgrade: () => void;
}

const LockedAutoPilotState: React.FC<LockedAutoPilotStateProps> = ({ onUpgrade }) => {
    const { language } = useUser();
    
    const t = {
        title: language === 'es' ? 'Activa el Piloto Automático' : 'Activate AutoPilot',
        ...
        cta: language === 'es' ? 'Desbloquear AutoPilot' : 'Unlock AutoPilot'
    };
...
export default LockedAutoPilotState;
