...
const PostEditorView: React.FC = () => {
    ...
    const HOOKS_LIBRARY = [
        ...
        {
            text:
                "Te garantizo que si haces esto, obtendrás [resultado deseado].",
        ...
        {
            text:
                "Cómo pasé de [estado inicial] a [estado final] en solo [tiempo].",
        ...
        {
            text:
                "¿Por qué nadie habla de [tema infravalorado]? Aquí mi opinión:",
        ...
        {
            text:
                "¿Qué harías diferente si estuvieras empezando con [actividad]?",
            tags: ["pregunta", "reflexión"],
        },
        {
            text:
                "¿Has oído hablar de [tendencia]? (¡No te lo quieres perder!)",
        ...
        {
            text:
                "Muchos [público objetivo] se equivocan en esto... Aquí la verdad.",
            tags: ["errores", "educar"],
        },
        {
            text:
                "[X] razones por las que no estás [acción/logrando resultado].",
            tags: ["consejos", "análisis"],
        },
        {
            text:
                "Deja de hacer [hábito común]. Está matando tu progreso en [meta].",
        ...
        {
            text:
                "Realidad: [estadística] y lo que implica para [industria/tema].",
        ...
        {
            text:
                "Lo más [adjetivo] que pasó cuando probé [estrategia/táctica].",
        ...
        {
            text:
                "La verdad detrás de [tema] - derribando los mitos más comunes.",
            tags: ["educar", "mitos"],
        },
        {
    ...
    const ENDINGS_LIBRARY = [
        ...
        {
            text:
                "¿Piensas que [X] es la clave para [RESULTADO]? Piénsalo de nuevo.",
            tags: ["provocar", "mito"],
        },
        {
            text:
        ...
        {
            text:
                "El momento es ahora. [BENEFICIO DE X]. [FRASE MOTIVACIONAL].",
            tags: ["motivar", "acción"],
        },
        {
            text:
                "Invierte en [X], y cosecha los frutos de [LOGRAR RESULTADO].",
        ...
        {
            text:
                "¿Cuál es tu [RECURSO/HERRAMIENTA] favorita para [ARTE/META]?",
            tags: ["interactuar", "pregunta"],
        },
        {
            text:
                "¿Cuál es tu estrategia infalible cuando [SITUACIÓN ESPECÍFICA]?",
            tags: ["interactuar", "pregunta"],
        },
        {
            text:
        ...
        {
            text:
                "¿Qué herramientas estás usando actualmente para [TAREA/META]?",
            tags: ["interactuar", "pregunta"],
        },
        {
            text:
        ...
        {
            text:
                "Cree en ti mismo y [HAZ X]. Tienes el poder de [LOGRAR META Y].",
        ...
        {
            text:
                "¿Por qué crees que [ESTRATEGIA/PLAN ESPECÍFICO] no funcionará?",
        ...
        {
            text:
                "¿Qué has encontrado cierto en tu experiencia como [POSICIÓN]?",
        ...
        {
            text:
                "Deja de perder tu tiempo en [X]. No te llevará ni cerca de [Y].",
            tags: ["provocar", "consejo"],
        },
        {
            text:
        ...
        {
            text:
                "En resumen: [HAZ X]. [HAZ Y]. [HAZ Z]. ¿Resultado? ¡Garantizado!",
            tags: ["resumen", "éxito"],
        },
        {
        ...
        {
            text:
                "Etiqueta a alguien que necesite un recordatorio de esto hoy. ❤️",
    ...
    const handleClearEditor = () => {
        if (
            window.confirm(language === "es" ? "¿Borrar todo?" : "Clear all?")
        ) {
            setEditorContent("");
        }
    };

    const handleSelectDraft = (post: any) => {
        ...
        <div className="flex h-full bg-white overflow-hidden select-none">
            ...
            <div className="flex-[1.5] flex flex-col min-w-0 border-r border-slate-200">
                ...
                <div className="h-12 border-b border-slate-100 flex items-center px-4 bg-white gap-0.5 shrink-0 overflow-x-auto no-scrollbar">
                    ...
                    <button className="p-2 hover:bg-slate-50 rounded-lg text-slate-400 rotate-45">
                ...
                <div className="h-16 border-t border-slate-100 flex items-center justify-between px-6 bg-white shrink-0">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="relative" ref={metricsMenuRef}>
                            <button
                                onClick={() =>
                                    setShowMetricsMenu(!showMetricsMenu)}
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setSelectedHookTag(e.target.value)}
                            ...
                            <div className="flex items-center gap-3">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        value={endingSearch}
                                        onChange={(e) =>
                                            setEndingSearch(e.target.value)}
                                        className="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all"
                                    />
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    : (
                                        <div className="text-center py-12 px-4">
                                            ...
                                            <p className="text-sm text-slate-500 leading-relaxed">
                                                Con los fragmentos puedes
                                                guardar firmas, llamadas a la
                                                acción o frases que usas a
                                                menudo.
                                                <br />
                                                <br />
                                                <span className="font-medium text-brand-600">
                                                    Selecciona texto en el
                                                    editor
                                                </span>{" "}
