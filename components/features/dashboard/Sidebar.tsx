...
interface SidebarProps {
    ...
    activeTab: 'create' | 'history' | 'settings' | 'autopilot' | 'auditor' | 'ideas';
    setActiveTab: (tab: 'create' | 'history' | 'settings' | 'autopilot' | 'auditor' | 'ideas') => void;
        ...
        <aside id="tour-sidebar" className={`bg-white border-r border-slate-200 flex flex-col h-full ${className}`}>
            ...
            <div className="flex-1 px-4 py-2 space-y-1 overflow-y-auto no-scrollbar">
                ...
                >
                    ...
                    {language === 'es' ? 'Auditor de Perfil' : 'Profile Auditor'}
