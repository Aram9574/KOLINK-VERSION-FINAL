...
import { Zap, Target, Type, Sliders, Smile, MessageSquare, Sparkles, AlignLeft, Wand2 } from 'lucide-react';
                        ...
                        <div className="flex bg-white rounded-lg p-1 border border-slate-200">
                            {EMOJI_OPTIONS.map((opt) => (
                                <button
                                    key={opt.value}
                                    type="button"
                                    onClick={() => onUpdateParams({ emojiDensity: opt.value as EmojiDensity })}
