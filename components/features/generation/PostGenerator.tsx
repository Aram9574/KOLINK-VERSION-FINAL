  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
        {/* Left Column: Title, Form, Tips (lg:col-span-5) */}
        <div className={`lg:col-span-5 space-y-6 ${activeView === 'preview' ? 'hidden lg:block' : 'block'}`}>
        ...
        {/* Right Column: Toggle, Preview (lg:col-span-7) */}
        <div className={`lg:col-span-7 flex flex-col h-full lg:pl-8 ${activeView === 'editor' ? 'hidden lg:flex' : 'flex'}`}>
          ...
          <div className={`transition-all duration-500 ease-in-out mx-auto w-full ${viewMode === 'mobile' ? 'max-w-[375px]' : 'max-w-xl'
            }`}>
            <LinkedInPreview
