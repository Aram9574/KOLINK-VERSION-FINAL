...
export const toast = {
  message: (args: Message) => {
    mountContainer();
    return toastStore.add(args.text, "message", args.preserve, args.action, args.onAction, args.onUndoAction);
  },
  success: (text: string, options?: { action?: string; onAction?: () => void }) => {
    mountContainer();
    return toastStore.add(text, "success", false, options?.action, options?.onAction);
  },
  error: (text: string, options?: { action?: string; onAction?: () => void }) => {
    mountContainer();
    return toastStore.add(text, "error", false, options?.action, options?.onAction);
  },
  warning: (text: string, options?: { action?: string; onAction?: () => void }) => {
    mountContainer();
    return toastStore.add(text, "warning", false, options?.action, options?.onAction);
  },
  dismiss: (id: number) => {
