...
import { Target, CheckCircle2, Check, Send } from 'lucide-react';
...
const FeatureWorkflow: React.FC<FeatureWorkflowProps> = ({ language }) => {
    ...
    return (
        <div className="col-span-12 lg:col-span-7 bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1">
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 group-hover:bg-amber-50/50 group-hover:border-amber-100 transition-colors">
                        ...
                        <span className="font-semibold text-slate-700">{t.features.noWritersBlock}</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 group-hover:bg-amber-50/50 group-hover:border-amber-100 transition-colors">
                        <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600">
                            <CheckCircle2 className="w-4 h-4" />
                        </div>
                        <span className="font-semibold text-slate-700">{t.features.mobileOptimized}</span>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-6 relative z-10">
                    <div className="flex gap-4 items-start opacity-40 grayscale group-hover:grayscale-0 group-hover:opacity-60 transition-all duration-500">
                        <div className="flex flex-col items-center gap-2">
                            <div className="w-8 h-8 rounded-full bg-white border border-slate-200 flex shrink-0 flex items-center justify-center text-xs font-bold text-slate-400 shadow-sm">1</div>
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-lg border border-amber-100 w-full animate-in slide-in-from-bottom-2 duration-700">
                            <div className="flex items-center justify-between mb-3 border-b border-slate-50 pb-2">
                                <div className="h-2 w-20 bg-amber-100 rounded-full"></div>
                                <span className="text-[10px] uppercase font-bold text-amber-500">{t.features.readyToPost}</span>
                            </div>
