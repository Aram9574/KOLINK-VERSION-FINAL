...
const DemoGeneratorView: React.FC<DemoGeneratorViewProps> = ({ language }) => {
    ...
    return (
        <div className="relative bg-slate-900/5 rounded-3xl p-2 ring-1 ring-slate-900/10 shadow-2xl transform hover:scale-[1.01] transition-transform duration-500 ease-out backdrop-blur-sm group will-change-transform">
            {/* App Window Frame */}
