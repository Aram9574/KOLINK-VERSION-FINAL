...
import { Sparkles, Play, Fingerprint, TrendingUp, Star, LayoutGrid, Lightbulb, Bot, History, Settings as SettingsIcon, MessageCircle, ThumbsUp, Repeat, Send, Wand2, ChevronDown } from 'lucide-react';
...
const HeroSection: React.FC<HeroSectionProps> = ({ language, user, mockContent, scrollToSection }) => {
