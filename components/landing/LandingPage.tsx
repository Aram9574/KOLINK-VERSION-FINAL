    ...
    return (
        <div className="bg-white font-sans selection:bg-brand-200 selection:text-brand-900">
            <Helmet>
                ...
                <meta name="description" content="Crea posts virales en segundos con IA. La herramienta definitiva para crecer en LinkedIn." />
            </Helmet>
            ...
            <main className="pt-20">
                ...
                <ComparisonSection language={language} mockContent={mockContent} />
